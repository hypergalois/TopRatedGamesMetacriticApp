import { fallbackDataGeneral, fallbackDataDetail } from "./fallbackData";

export async function getLatestGames() {
	const LATEST_GAMES =
		"https://internal-prod.apigee.fandom.net/v1/xapi/finder/metacritic/web?sortBy=-metaScore&productType=games&page=1&releaseYearMin=1998&releaseYearMax=2024&offset=0&limit=24&apiKey=1MOZgmNFxvmljaQR1X9KAij9Mo4xAY3u";
